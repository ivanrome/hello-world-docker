...
CMD ["java", "-cp", "/usr/local/docker-git-hello-world/target/org.ivan.docker-0.0.1-SNAPSHOT-jar-with-dependencies.jar", "org.ivan.docker.HelloWorldPing"]
